...
class CreateOrderSagaTest {
    ...
    fun testStep() = runBlocking {
        ...
        val orderDetails = orderDetailsDAO.create(OrderDetails(0, "test",Timestamp(System.currentTimeMillis()),  customer, listOf(MenuItem(0, 1, 1))))!!
        ...
        Mockito.`when`(kitchenServiceProxyMock.createTicket(sagaState.sagaId, customer.id, orderDetails.menuItems)).thenReturn(true)
